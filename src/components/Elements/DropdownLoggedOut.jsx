...
export const DropdownLoggedOut = () => {
  return (
    <div id="dropdownAvatar" className="select-none	absolute top-10 right-0 z-10 w-44 bg-darkBlue rounded divide-y divide-gray-100 shadow dark:bg-gray-700 dark:divide-gray-600">
